...
export async function assertTypiaWebpackCompatibility({
  ...
  const isSupported =
    ...
    matchesMajorMinor(versionMatrix.ttsc, 0, 23) &&
    parseMajorVersion(versionMatrix.typescript) === 7 &&
    matchesMajorMinor(versionMatrix['@ttsc/unplugin'], 0, 23) &&
  ...
  throw new Error(
    [
      ...
      'Supported matrix: typia 13.x, ttsc 0.23.x, TypeScript 7.x, @ttsc/unplugin 0.23.x, @wordpress/scripts 30.x with webpack 5.x.',
