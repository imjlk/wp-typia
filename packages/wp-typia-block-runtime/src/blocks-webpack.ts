...
export async function assertTypiaWebpackCompatibility({
  ...
  const isSupported =
    ...
    matchesMajorMinor(versionMatrix.ttsc, 0, 22) &&
    parseMajorVersion(versionMatrix.typescript) === 7 &&
    matchesMajorMinor(versionMatrix['@ttsc/unplugin'], 0, 22) &&
  ...
  throw new Error(
    [
      ...
      'Supported matrix: typia 13.x, ttsc 0.22.x, TypeScript 7.x, @ttsc/unplugin 0.22.x, @wordpress/scripts 30.x with webpack 5.x.',
