...
export interface SyncTypiaLlmAdapterModuleOptions
  extends ArtifactSyncExecutionOptions, RenderTypiaLlmModuleOptions {
 ...
 * result.
 */
export interface TypiaLlmFunctionLike extends Pick<
  ILlmFunction,
  'description' | 'name' | 'output' | 'parameters'
> {
 ...
 */
export interface TypiaLlmStructuredOutputLike extends Pick<
