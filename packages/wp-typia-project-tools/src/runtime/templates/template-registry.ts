...
export function resolvePackageRoot(startDir: string): string {
  ...
  while (true) {
    ...
    if (fs.existsSync(packageJsonPath)) {
      try {
        const packageJson = readJsonFileSync<{ name?: string }>(
          packageJsonPath,
          {
...
export const SHARED_BASE_TEMPLATE_ROOT = path.join(
  SHARED_TEMPLATE_ROOT,
  'base',
);
export const SHARED_COMPOUND_TEMPLATE_ROOT = path.join(
  SHARED_TEMPLATE_ROOT,
  'compound',
);
export const SHARED_PERSISTENCE_TEMPLATE_ROOT = path.join(
  SHARED_TEMPLATE_ROOT,
  'persistence',
);
export const SHARED_PRESET_TEMPLATE_ROOT = path.join(
  SHARED_TEMPLATE_ROOT,
  'presets',
);
export const SHARED_REST_HELPER_TEMPLATE_ROOT = path.join(
  SHARED_TEMPLATE_ROOT,
  'rest-helpers',
);
export const SHARED_MIGRATION_UI_TEMPLATE_ROOT = path.join(
  SHARED_TEMPLATE_ROOT,
  'migration-ui',
);
/**
 ...
 */
export const SHARED_WORKSPACE_TEMPLATE_ROOT = path.join(
  SHARED_TEMPLATE_ROOT,
  'workspace',
);
export const SHARED_TEST_PRESET_TEMPLATE_ROOT = path.join(
  SHARED_PRESET_TEMPLATE_ROOT,
  'test-preset',
);
export const SHARED_WP_ENV_PRESET_TEMPLATE_ROOT = path.join(
  SHARED_PRESET_TEMPLATE_ROOT,
  'wp-env',
);
...
export const TEMPLATE_REGISTRY = Object.freeze<TemplateDefinition[]>([
  ...
  },
  {
    ...
    features: [
      'core/query variation',
      'Default innerBlocks',
      'Connected patterns',
      'Custom query hooks',
      'Runtime parity hooks',
      'Allowed controls',
    ],
