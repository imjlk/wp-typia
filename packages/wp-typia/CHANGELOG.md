...
- [050cb9ba](https://github.com/imjlk/wp-typia/commit/050cb9baa5b41925a1bfa28d4ab5c684c0c7c4e2) Fixed: MCP built-in tool schema accuracy and namespace collision prevention.
  ...
  - External MCP groups that reuse the reserved `wp-typia` namespace are filtered out to prevent duplicate namespace collisions during sync. — Thanks Junglei Kim!
...
- Updated dependencies: api-client (npm)@0.5.0, project-tools (npm)@0.25.0
...
- Updated dependencies: project-tools (npm)@0.24.12
...
- Updated dependencies: project-tools (npm)@0.24.9
...
- [c0b4432c](https://github.com/imjlk/wp-typia/commit/c0b4432c2f0c993584e4491f7df583cb8f647486) Polish interactive add prompts and expose legacy pattern tag warnings in structured CLI output. — Thanks @imjlk!
- Updated dependencies: project-tools (npm)@0.24.7
