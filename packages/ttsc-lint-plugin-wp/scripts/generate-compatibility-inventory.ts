...
registerImplementedRule('components-no-missing-40px-size-prop');
registerImplementedRule('components-no-unsafe-button-disabled');
registerImplementedRule('data-no-store-string-literals');
registerImplementedRule('dependency-group');
...
registerImplementedRule('no-dom-globals-in-constructor');
...
registerImplementedRule('no-non-module-stylesheet-imports');
...
registerImplementedRule('no-unmerged-classname');
...
registerImplementedRule('use-import-as');
registerImplementedRule('use-recommended-components');
